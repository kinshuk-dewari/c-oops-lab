...
int main()
{
    ...
    cout<<"Abstraction was in the base class in the Above implementation \nand not in the child class because pure virtual function of base\nwas defined in child class."<<endl;
}
